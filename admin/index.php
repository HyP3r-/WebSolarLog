        ...
        <div id="main">
            ...
            <div id="main-middle">
                ...
                <header>
                    ...
                    <font color="#ff0000;">Recently we made a high impact change on the way WSL is configured to
                        communicate with external devices. Please see Admin::Communication and this forum post for more
                        info:</font>
                ...
                <div class="column last">
                    <button id="forceGet">force page reload</button>
                </div>
            </div>
