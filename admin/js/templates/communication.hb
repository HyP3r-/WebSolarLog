...
<form id="frm_comm_edit">
    ...
    <fieldset>
        ...
        <label for="timeout">timeout:</label><input type="text" class="commTextField" name="timeout"
                                                    value="{{data.timeout}}"/><br/>
        <label for="optional">optional:</label><input type="text" class="commTextField" name="optional"
                                                      value="{{data.optional}}"/><br/>
