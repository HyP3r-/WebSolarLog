    ...
    <fieldset>
        ...
        <div id="device_info" style="display:none; margin-top: 10px;">
            <form>
                ...
                <span style="width: 6em; display:inline-block; font-weight: bold;">name</span><input type="text"
                                                                                                     id="device_name"
                                                                                                     name="name"
                                                                                                     disabled="disabled"/><br/>
                <span style="width: 6em; display:inline-block; font-weight: bold;">address</span><input type="text"
                                                                                                        id="device_address"
                                                                                                        name="address"
                                                                                                        disabled="disabled"/><br/>
                <span style="width: 6em; display:inline-block; font-weight: bold;">device API</span><span
                    id="device_api"/><br/>
...
<div style="margin-top: 10px;" id="lastTestInfo">
    ...
    <span style="width: 6em; display:inline-block; font-weight: bold;">test result:</span><span
        id="lastTestResult"/><br/>
