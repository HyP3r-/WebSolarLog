{{#data.inverters}}
<button type="button" id="btnInverter_{{this.id}}" class="inverter_select" style="width:100%;">{{this.name}}</button>
<br/>
{{/data.inverters}}
<br/>
<hr>
...
<form>
    ...
    <br><br>
    <button type="button" id="new_device" style="width:100%;">Create device</button>
    <br/><br/>
</form>
