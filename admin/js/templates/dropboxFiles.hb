<form>
    ...
    <fieldset>
        ...
        <div class="column span-40">
            ...
            <div style="overflow-y: scroll; height:312px;overflow-x:hidden;" class="column span-28 last"
                 id="dropboxFilesContainter">
                {{#each data.files}}
                ...
                <div class="column span-28" id="file{{id}}">
                    ...
                    <div class="column span-4 last">
                        <a href="{{fullPath}}"><img src="images/page_white_put.png" id="download{{id}}"
                                                    class="icon downloadFile" title="Download:{{path}}"/></a>&nbsp;|&nbsp;
                        <img src="images/page_white_delete.png" id="delete{{id}}" class="icon deleteFile"
                             title="Permanent Delete:{{path}}"/>
                    </div>
                </div>
                {{/if_eq}}
