<script type="text/javascript">
    function initialize() {
        middleWorld = new google.maps.LatLng({
        {
            lat
        }
    }
...
<div id="dialog-modal" title="Set location for sun calculations">
    ...
    <div class="column span-15">
        ...
        <div class="column span-3"><input disabled="disabled" type="text" value="{{lat}}" id="mapsLat"
                                          style="width:130px;"/></div>
        <div class="column span-8 last">&nbsp;</div>
        <div class="column span-3 first">longitude</div>
        <div class="column span-3"><input disabled="disabled" type="text" value="{{long}}" id="mapsLong"
                                          style="width:130px;"/></div>
        <div class="column span-8 last">&nbsp;</div>
        <div class="column span-15">
            <div class="column span-3 first">round:</div>
            <div class="column span-4">
                <select id="roundLatLong">
                    ...
                    <option value="100000000" selected>8</option>
                </select>
            </div>
