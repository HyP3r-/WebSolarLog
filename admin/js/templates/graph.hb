    ...
    <fieldset style="width:560px;">
        ...
        <div class="column" style="width:556px;">
            <div class="column last" style="width:80px;border:1px solid #ddd;height:75px;">
                <div style="margin-left:auto;margin-right:auto;width:40px;">left<br>yaxis</div>
            </div>
            <div class="column last" style="width:250px;border:1px solid #ddd;height:75px;">
                <div style="margin-left:auto;margin-right:auto;width:110px;"><br>graph lines section</div>
            </div>
            <div class="column last" style="width:220px;border:1px solid #ddd;height:75px;">
                <div style="margin-left:auto;margin-right:auto;width:60px;">right<br>y(2-8)axis</div>
            </div>
        ...
        <div class="column span-28">
            <form method="post" id="axe-{{this.id}}">
                ...
                <div class="column span-8"><input type="text" style="width:160px" name="label" class="label"
                                                  value="{{this.json.label}}"></div>
                    ...
                    <form id="serie-{{this.id}}">
                        ...
                        <div class="column span-8 first">
                            <select name="yaxis" class="saveSerie" width="60" style="width: 60px">
                                {{#../data.axesList}}
                                <option value="{{this.axe}}" {{#if_eq this.axe
                                        compare=../this.json.yaxis}}selected{{/if_eq}}>{{this.axe}}&nbsp;&nbsp;&nbsp;({{this.label}})
                                </option>
                                {{/../data.axesList}}
                            </select>
                        </div>
