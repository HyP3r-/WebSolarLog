...
<font color="#ff0000;">Recently we made a high impact change on the way WSL is configured to communicate with external
    devices.<br>
...
<div id="showUpdateOption">
    ...
    <br/>
    <input type="checkbox" id="chkBeta" value="1" {{#if beta}}checked='checked' {{/if}}/>&nbsp;<b>Show Beta
    versions<b><br/>
        <span style="color:#ff0000">Not supported!</span>
        <br/><br/>
        <input type="checkbox" id="chkExperimental" value="1" {{#if experimental}}checked='checked' {{/if}}/>&nbsp;<b>Show
            Trunk versions<b><br/>
                <span style="color:#ff0000">Not supported!</span>
                <br/><br/>
                <hr>
