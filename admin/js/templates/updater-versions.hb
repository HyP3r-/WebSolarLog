    ...
    <ul style="list-style-type: none;">
        <li>
            <ul>
                ...
                <li style="list-style-type: none;">{{data.currentVersionReleaseTime}}({{data.currentVersionRevision}})
                </li>
                <li>You updated on:</li>
                <li style="list-style-type: none;">{{data.currentVersionUpdateTime}}</li>
                <li>Description:</li>
                <li style="list-style-type: none;">{{data.currentVersionReleaseDescription}}</li>
            </ul>
    </ul>
    </li></ul></div>
