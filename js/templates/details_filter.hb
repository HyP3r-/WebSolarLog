<div id="filter">
    <div style="float: right;">
        <button type="button" id="btnToggleFilter">hide</button>
    </div>
    <form>
        <h2>Filter</h2>
        <span style="width: 5em; display: inline-block">Date from:</span><input type="text" id="dateFrom"
                                                                                style="width:6em;"><br/>
        <span style="width: 5em; display: inline-block">Date to:</span><input type="text" id="dateTo"
                                                                              style="width:6em;"><br/>
        <br/>
        <table>
            <thead>
