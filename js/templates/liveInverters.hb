...
<div class="column span-27  liveToolTip">
    ...
    <div class="column span-3" title="{{this.live.totalDeviceACP}} W = {{this.live.GV}} V * {{this.live.GA}} A">
        {{this.live.totalDeviceACP}}
    </div>
    <div class="column span-4" title="{{this.live.I1P}} W = {{this.live.I1V}} V * {{this.live.I1A}} A">{{this.live.I1P}}
        ({{this.live.I1Ratio}})
    </div>
    <div class="column span-4" title="{{this.live.I2P}} W = {{this.live.I2V}} V * {{this.live.I2A}} A">{{this.live.I2P}}
        ({{this.live.I2Ratio}})
    </div>
