<div id="todayPosts">
    <div class="columns"><h3>Misc</h3>
        ...
        <div class="col posts">
            ...
            {{data.serverUptime.day}} {{lang.days}},{{data.serverUptime.hour}} {{lang.hours}},{{data.serverUptime.min}}
            {{lang.mins}}<br>
            <br>
        </div>
        <div class="cl"></div>
                        ...
                        <div class="innerAccordionPeriod">
                            <div class="post">
                                ...
                                <table width="100%">
                                    ...
                                    <a href="http://pvoutput.org/list.jsp?sid={{this.pvoutputSystemId}}"
                                       target="_blank">Checkout my PVoutput page</a><br><br>
                                    {{#if_eq this.pvoutputWSLTeamMember compare=1}}
                                    and I'm a proud member of the <a href="http://pvoutput.org/listteam.jsp?tid=602"
                                                                     target="_blank">PVoutput WebSolarLog team</a> :)
                                    {{else}}
                                    and unfortunately i'm not a member of the <a
                                        href="http://pvoutput.org/listteam.jsp?tid=602" target="_blank">WebSolarLog
                                    team</a> :(
                                    {{/if_eq}}

                                    {{else}}
                                    This device itself is not submitting to PVoutput.<br>
                                    It could be that the data from this device is used by another device to submit
                                    is.<br>
                                    {{/if_eq}}
        ...
        <div class="col posts">
            <div class="column span-22 last">
                ...
                <div class="post">
                    ...
                    <div class="column span-4" title="{{timestampDateFormat this.events.info.time format=" HH:mm:ss
                    "}}">{{timestampDateFormat this.events.info.time format="DD MMM YYYY"}}
                </div>
                ...
                <div class="column span-22 accordion">
                    ...
                    <div class="innerAccordionPeriod">
                        ...
                        <div class="column span-20">
                            ...
                            <div class="column span-4"><a
                                    href="http://maps.google.com/maps?q={{../../data.slimConfig.lat}},+{{../../data.slimConfig.long}}+%28...%29&iwloc=A&hl=en&z=15"
                                    target="_blank">{{../../data.slimConfig.lat}}:{{../../data.slimConfig.long}}</a>
                            </div>
                        </div>
                        <div class="column span-20">
                            {{#each this.panels}}
                            ...
                            <div class="column span-19 prepend-2">
                                ...
                                <div class="column span-5">{{this.amount}}*{{this.wp}}={{this.totalWp}}
                                    {{../../../lang.wp}}
                                </div>
                ...
                <div class="innerAccordionPeriod">
                    ...
                    <div class="post">
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                <td style="white-space: nowrap;" title="{{timestampDateFormat this.time format="
                                    HH:mm:ss
                                "}}">{{timestampDateFormat this.time format="DD MMM YYYY"}}</td>
