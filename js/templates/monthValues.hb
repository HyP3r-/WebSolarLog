                    ...
                    <div class="post">
                        <div id="monthPowerAcc" class="column span-22 last accordion">
                            ...
                            <div class="innerAccordionPeriod">
                                ...
                                " style="text-align:right;">{{timestampDateFormat this.date format="DD MMM YYYY"}}
                            </div>
                            {{/each}}
                        </div>
                        {{/each}}
        ...
        <div class="post">
            ...
            <div id="monthPowerAcc" class="column span-22 last accordion">
                ...
                <div class="innerAccordionPeriod">
                    ...
                    <div class="column span-9 last">{{timestampDateFormat this.minMaxEnergy.maxEnergy.date format="DD
                        MMM YYYY"}}
                    </div>

                    <div class="column span-4">The Worst:</div>
                    <div class="column span-3" style="text-align:right;">{{this.minMaxEnergy.minEnergy.kWh}}</div>
                    <div class="column span-9 last">{{timestampDateFormat this.minMaxEnergy.minEnergy.date format="DD
                        MMM YYYY"}}
                    </div>
                </div>
                {{/each}}
