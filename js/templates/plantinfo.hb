<div id="right" style="height:170px;">
    ...
    <hr class="hr_info"/>
    {{data.langTOTALPROD}} {{data.valueKWHP}} kWh<br/>
    <img src='images/leaf.png' width='16' height='16' border='0'/> {{data.valueCO2}} {{data.valueCO2v}} CO<sub>2</sub>&nbsp;<img
        src='images/info10.png' width='10' height='10' border='0' title='{{data.langECOLOGICALINFOB}}'/>
</div>
<div id="left" style="height:170px;">
    <img src="images/brightness.png" class="icon"><b>&nbsp;{{data.langPLANTINFO}}
</b><br/>
    <hr class="hr_info"/>
    <a href="plantdetails.php">
        <imgsrc
        ="images/zoom.png" width="32" height="32" border="0"> </a>
...
<div id="left" style="height:280px;">
    ...
    <img src='images/info10.png' width='10' height='10' border='0'
         title="{{data.langINVERTERINFOB}} {{data.valueUpdtd}}"/><br/>
    <hr class="hr_info"/>
    <ul>
        {{#data.valueInverter}}
        <li>{{this}}</li>
