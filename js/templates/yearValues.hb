                        ...
                        <div id="yearPowerAcc" class="column span-22 last accordion">
                            ...
                            <div class="innerAccordionPeriod">
                                ...
                                " style="text-align:right;"><a
                                    href="month.php?date={{timestampDateFormat this.date format=" DD-MM-YYYY"}}">{{timestampDateFormat
        ...
        <div class="post">
            <div id="yearPowerAcc" class="column span-22 last accordion">
                ...
                <div>
                    ...
                    <div class="column span-9" last
                    " style="text-align:right;">{{timestampDateFormat this.date format="DD-MM-YYYY"}}
                </div>
                {{/each}}
            </div>
            {{/each}}
        ...
        <div class="post">
            ...
            <div id="yearPowerAcc" class="column span-22 last accordion">
                ...
                <div>
                    ...
                    <div class="column span-9 last">
                        {{timestampDateFormat this.maxEnergy.date format="DD-MM-YYYY"}}
                    </div>

                    <div class="column span-4">The Worst:</div>
                    <div class="column span-3" style="text-align:right;">{{this.minEnergy.kWh}}</div>
                    <div class="column span-9 last">{{timestampDateFormat this.minEnergy.date format="DD-MM-YYYY"}}
                    </div>
                </div>
                {{/each}}
            </div>
